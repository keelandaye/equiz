...
<body>
    ...
    <div id="loginform" class="col-md-4">
      ...
      <div class="alert alert-danger alert-dismissible" role="alert">
        ...
        <strong>Error!</strong> Please enter class name.
      </div>
      '; }?>
      <br>
      <form action="methods/newclass.php" method="POST">
        <input type="text" class="form-control" name="class" placeholder="Class Name">
        <br>
        <input type="submit" class="form-control btn btn-default" value="Add Class">
      </form>
    </div>
    <div class="col-md-4"></div>
    </div>
